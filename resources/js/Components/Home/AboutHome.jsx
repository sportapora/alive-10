        ...
        <>
            <div className="flex flex-col md:flex-row bg-[#EAC09E] justify-center">
                <div className=" flex justify-center">
                    <img src="Assets/Images/home_assets/logo alive-04.png" className="w-[108px] md:w-[369px] h-[100%] object-contain"/>
                </div>
                <div className="bg-[#E8E8E8] p-8 w-[239px] md:h-[450px] justify-center rounded-xl mb-5">
                    ...
                    <button className="bg-[#ED9948] w-[177px] rounded-xl">read more</button>
                </div>
            </div>
        </>
    );
