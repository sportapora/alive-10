                ...
                <div className="relative md:top-20 gap-3 lg:gap-10 flex flex-col justify-center sm:flex-row lg:justify-start">
                    ...
                    <div className="flex flex-col w-full md:w-1/2">
                        ...
                        <p className="-mt-2 font-normal font-jost text-base md:text-lg lg:text-xl text-justify">
                            FACE merupakan rangkaian pertama ALIVE 10.0, di mana
                            nantinya akan terdapat booth kesehatan. Acara ini
                            menawarkan konsultasi kesehatan kulit secara on-site
                            untuk seluruh <i>civitas</i> UMN dari kalangan
                            mahasiswa, dosen, dan staf. Booth ini bertujuan
                            memberikan fasilitas pemeriksaan dan konsultasi
                            kesehatan kulit, sekaligus memberikan pengetahuan
                            lebih lanjut tentang cara optimal merawat kulit.
                        </p>
                    </div>
                </div>
            </div>
