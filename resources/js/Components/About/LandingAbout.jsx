...
function LandingAbout() {
    return (
        <>
            <div className="bg-[#EAC09E] h-[1400px] md:h-[1300px] lg:h-[900px] md:p-0 p-10 overflow-hidden">
                <div className="flex lg:flex-row flex-col gap-20 items-center justify-center relative top-20">
                    <div className="flex flex-col text-black md:text-justify text-center lg:w-[40%] w-[80%]">
                        ...
                        <p className="md:text-[24px] text-[16px] mt-4 text-justify">
                            ...
                            diakhiri dengan Talk Show yang merupakan puncak acara ALIVE 10.0. Acara ini bertujuan untuk meningkatkan
                    ...
                    <div className="flex flex-row mt-20">
                        ...
                        <img
                            alt="ALIVE 9.0"
                            className="md:w-[300px] md:h-[400px] rounded-[60px] w-[250px] h-[300px] absolute inset-0 md:top-[35%] md:left-[60%] lg:left-[75%] lg:top-[25%] top-[85%] left-[50%] object-cover" src="/Assets/Images/about/about-1.jpg" />
                    </div>
                </div>
            </div>
        </>
